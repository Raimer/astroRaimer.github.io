...
* **AGN feedback** (the typical luminosity of Syfert-like activity is ```kramdown \(10^{41}\)``` erg) & **stellar feedback** (the typical kinetic energy of type II supernova ejecta is $$10^{51}$$ erg)
